...
class Client(object):
    ...
    def __init__(self, config_file):
        ...
        self.app_parser = AppParser(self.config.history_server)
        self.job_parser = JobParser(self.config.history_server)
        self.stage_parser = StageParser(self.config.history_server)
